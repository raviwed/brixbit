...
export const PlaintextEnvelope = {
    encode(message, writer = _m0.Writer.create()) {
...
export const PlaintextEnvelope_V1 = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.content.length !== 0) {
...
export const PlaintextEnvelope_V2 = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.idempotencyKey !== "") {
...
export const MessageHistoryRequest = {
    encode(message, writer = _m0.Writer.create()) {
...
export const MessageHistoryReply = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.requestId !== "") {
            writer.uint32(10).string(message.requestId);
        }
        ...
        if (message.signingKey !== undefined) {
            MessageHistoryKeyType.encode(message.signingKey, writer.uint32(34).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.signingKey = MessageHistoryKeyType.decode(reader, reader.uint32());
                    break;
                case 5:
    ...
    fromJSON(object) {
        return {
            ...
            signingKey: isSet(object.signingKey)
                ? MessageHistoryKeyType.fromJSON(object.signingKey)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.signingKey !== undefined &&
            (obj.signingKey = message.signingKey
                ? MessageHistoryKeyType.toJSON(message.signingKey)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.signingKey =
            object.signingKey !== undefined && object.signingKey !== null
                ? MessageHistoryKeyType.fromPartial(object.signingKey)
                : undefined;
...
export const MessageHistoryKeyType = {
    encode(message, writer = _m0.Writer.create()) {
