import { getAddress, bytesToHex as bytesToHex$1, keccak256, hexToSignature, hexToBytes, hashMessage, verifyMessage } from 'viem';
import Long from 'long';
import { fetcher, ciphertext, privateKey, signature, publicKey, keystore, message, content, messageApi, contact, authn, invitation, privatePreferences, composite } from '@brixbit/proto';
import * as secp from '@noble/secp256k1';
import { webcrypto } from 'crypto';
import { Mutex } from 'async-mutex';
import elliptic from 'elliptic';
import { user_preferences_encrypt, user_preferences_decrypt, generate_private_preferences_topic } from '@brixbit/user-preferences-bindings-wasm';
